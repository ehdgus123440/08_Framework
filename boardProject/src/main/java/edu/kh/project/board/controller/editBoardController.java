...
public class editBoardController {
	...
	/*
	 * @PathVariable 사용 시 정규 표현식 적용 가능!! {변수명:정규표현식}
	 */
	 ...
	 * @param inputBoard  : 제출된 key값이 일치하는 필드에 값이 저장된 객체 (커맨드 객체)
	...
	public String boardInsert(@PathVariable("boardCode") int boardCode, @ModelAttribute Board inputBoard,
		 ...
		 * 
		 * * 선택된 파일이 없더라도 빈칸으로 제출이 된다!!! ex)0,2,4 인덱스만 선택 -> 0,2,4는 제출된 파일이 있고 1,3은 빈칸으로
		 * 존재
		 */
